...
public class SplitBySentenceTest {
    ...
    public void splitBySentence_withOneWord() throws IOException {
        ...
        Node<Node<String>> result = splitBySentence(list);
        assertTrue(ListUtilTest.withoutDots((Node<String>) result.next.value));
    ...
    public void splitByUnit_oneSingleElementInEachList() throws IOException {
        ...
        while (curr != result) {
            assertTrue(ListUtilTest.withoutDots((Node<String>) curr.next.value));
            curr = curr.next;
        }
    ...
    @Test
    public void splitByUnit_MoreThanOneElementInEachListAndWithOtherPonctuation() throws IOException {
